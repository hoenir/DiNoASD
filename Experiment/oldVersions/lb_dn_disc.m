...
param.nr_frames_ISI_resp = round(time_ISI_resp/1000*Current_FrameRate);
...
%conditions
%within blocks
contrast_vector = logspace(log10(0.02), log10(0.20),5);
or_vector = 90;
side_vector = [1 2];%whether test stimulus is shown left(1) or right(0)

%between blocks
cond_vector = [0 0.50];%detection or discrimination task
%--------------------------------------------------------------------------
